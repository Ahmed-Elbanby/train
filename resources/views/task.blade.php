            ...
            <div class="table-responsive">
              <table class="table table-striped table-hover mb-0">
                ...
                <tbody>
                  ...
                  @php
                    // calculating hour cost
                    $employeeHourCost = round($employee->salary / 30 / 8, 2);
                  @endphp
                    <tr>
                      <td>{{ $employee->id }}</td>
                      <td>{{ $employee->name }}</td>
                      <td>{{ $employee->salary }}</td>
                      <td>{{ $employeeHourCost }}</td>
                    </tr> 
                  @endforeach
                </tbody>
              </table>
              ...
              <table class="table table-bordered table-hover mb-0">
                ...
                <tbody>
                  ...
                  @php
                    ...
                    $totalDays = (strtotime($project->end_date) - strtotime($project->start_date)) / (60 * 60 * 24);
                    ...
                    foreach ($project->employees as $employee) {
                      $employeeHourCost = round($employee->salary / 30 / 8, 2);
                      $employeeHours = $employee->workTimes()->where('project_id', $project->id)->sum('hours');
                      $totalProjectCost += $employeeHourCost * $employeeHours;
                    }
                  @endphp
                  <tr>
                    <td>{{ $project->id }}</td>
