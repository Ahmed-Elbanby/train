                        ...
                        <div class="dropdown-menu rounded-4 shadow border-0 p-0" data-bs-popper="none">
                            <div class="card">
                                <div class="row g-1 text-center p-3" style="width: 302px;">
                                    <div class="col-6">
                                        <a class="card p-3 color-600 lift align-items-center" href="./dashboard.html"
                                            title="">
                                    ...
                                    <div class="col-6">
                                        <a class="card p-3 color-600 lift align-items-center" href="./crafted-page.html"
                                            title="">
                                            <svg viewBox="0 0 16 16" width="30px" class="mb-3" fill="currentColor"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                    ...
                                    <div class="col-6">
                                        <a class="card p-3 color-600 lift align-items-center" href="./layouts.html"
                                            title="">
                                            <svg viewBox="0 0 16 16" width="30px" class="mb-3" fill="currentColor"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                        ...
                        <div class="dropdown-menu border-0 rounded-4 shadow p-0">
                            <div class="card border-0 w240">
                                ...
                                <a href="./auth-signin.html"
                                    class="btn bg-secondary text-light text-uppercase rounded-0">Sign
                                    out</a>
                            </div>
                        </div>
                    </div>
