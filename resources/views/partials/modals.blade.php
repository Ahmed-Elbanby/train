            ...
            <div class="tab-pane fade show active" id="step1">
                      ...
                      <span class="card">
                        <span class="card-body d-flex p-3">
                          ...
                          <span class="ms-3">
                            ...
                            <span class="text-muted">For smaller business, with simple salaries and pay
                              schedules.</span>
                          </span>
                        </span>
                      </span>
                      ...
                      <span class="card">
                        <span class="card-body d-flex p-3">
                          ...
                          <span class="ms-3">
                            ...
                            <span class="text-muted">For growing business who wants to create a rewarding place to
                              work.</span>
                          </span>
                        </span>
                      </span>
              ...
              <div class="card mb-2">
                <div class="card-body">
                  ...
                  <p class="text-muted small">It is a long established fact that a reader will be distracted by Luno.
                  </p>
            ...
            <div class="tab-pane fade" id="step2">
              <div class="card mb-3">
                <div class="card-body">
                  ...
                  <p class="text-muted small">If you need more info, please check out <a href="#">Project Guidelines</a>
                  </p>
      ...
      <div class="modal-content">
        ...
        <div class="bg-light px-4 py-3">
          <ul class="nav nav-pills nav-fill" role="tablist">
            <li class="nav-item">
              <a class="nav-link active" data-bs-toggle="tab" href="#Notetab-all" role="tab" aria-selected="true">All
                Notes</a>
            </li>
            <li class="nav-item">
            ...
            <div class="tab-pane fade active show" id="Notetab-all" role="tabpanel">
              <div class="card ribbon mb-2">
                ...
                <div class="card-body">
                  ...
                  <span>It has roots in a piece of classical Latin literature from 45 BC, making it over 2020 years
                    old.</span>
                </div>
              ...
              <div class="card ribbon mb-2">
                ...
                <div class="card-body">
                  ...
                  <span>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default
                    model</span>
                </div>
                <div class="card-footer pt-0 border-0">
                  <a class="btn btn-sm btn-outline-secondary" href="#"><i class="fa fa-star favourite-note"></i></a>
                  ...
                  <ul class="list-unstyled chat-history flex-grow-1">
                    ...
                    <li class="mb-3 d-flex flex-row align-items-end">
                      <div class="max-width-70">
                        ...
                        <div class="card p-3">
                          <div class="message"> It is a long established fact that a reader will be distracted by the
                    ...
                    <li class="mb-3 d-flex flex-row-reverse align-items-end">
                      <div class="max-width-70 text-end">
                        ...
                        <div class="card border-0 p-3 bg-primary text-light">
                          <div class="message">Yes, Orlando Allredy done <br> There are many variations of passages of
                            Lorem Ipsum available</div>
                        </div>
                      </div>
